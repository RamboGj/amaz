	...
	return (
		<div className="h-screen flex flex-col justify-center items-center w-full bg-[#131313] bg-[url('/Elements.png')] bg-no-repeat bg-cover px-6 lg:px-0">
			...
			>
				...
				<button
					type="button"
					className="h-[56px] block mt-8 bg-green500 rounded-[12px] outline outline-offset-[-1px] outline-white/20 hover:cursor-pointer hover:bg-green400 transiton duration-500"
				>
